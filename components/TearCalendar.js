...
export default function TearCalendar() {
  ...
  const pageStyle = {
    ...
    transition:     completing ? 'transform 0.42s cubic-bezier(0.4,0,0.6,1)'
                  : snapping  ? 'transform 0.3s ease-out'
                  : 'none',
        ...
        <div className={styles.calendarBlock}>
          ...
          >
            ...
            <div className={styles.tearLine}>
              {Array.from({ length: 22 }, (_, i) => <span key={i} className={styles.tearDot} />)}
            </div>
